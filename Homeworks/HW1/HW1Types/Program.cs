...
namespace HW1Types
{
    public class HW1Types
    {
        static void Main(string[]args)
        {
            ...
            Console.WriteLine($"\nBut, there is only {islandCount} main islands.");
            ...
            Console.WriteLine("now lets calculate the area of a triangle using heron's formula.");
            double a = 3.0;
            double b = 4.0;
